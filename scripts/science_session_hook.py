...
def _active_context(session_id: str, generation: str) -> str:
    ...
    return (
        ...
        f"{key} to science_checkpoint.py init or claim so lifecycle hooks can find only the "
        "checkpoint owned by this activation generation. When native Goal mode is explicitly "
        "requested, call "
