...
- Upstream license: `BSD license`
- Inventory: `../../inventory.json`
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/deeptools/SKILL.md`
...
The upstream `SKILL.md` is 536 lines. Inspect its headings first, then
