...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/clinical-reports/SKILL.md`
...
The upstream `SKILL.md` is 1131 lines. Inspect its headings first, then
