...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/scientific-schematics/SKILL.md`
...
The upstream `SKILL.md` is 618 lines. Inspect its headings first, then
