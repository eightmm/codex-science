...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/scientific-slides/SKILL.md`
...
The upstream `SKILL.md` is 1154 lines. Inspect its headings first, then
