...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/scientific-writing/SKILL.md`
...
The upstream `SKILL.md` is 717 lines. Inspect its headings first, then
