...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/citation-management/SKILL.md`
...
The upstream `SKILL.md` is 1250 lines. Inspect its headings first, then
