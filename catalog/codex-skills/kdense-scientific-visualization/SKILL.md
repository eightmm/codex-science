...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/scientific-visualization/SKILL.md`
...
The upstream `SKILL.md` is 776 lines. Inspect its headings first, then
