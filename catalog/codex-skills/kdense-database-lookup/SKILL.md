...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/database-lookup/SKILL.md`
...
The upstream `SKILL.md` is 533 lines. Inspect its headings first, then
