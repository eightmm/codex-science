...
- Status: `inactive`
- Source: `kdense`
- Audit reasons: `credentials-required`, `executable-content`, `unsafe-instruction`
- Upstream license: `MIT license`
- Inventory: `../../inventory.json`
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/literature-review/SKILL.md`
...
The upstream `SKILL.md` is 710 lines. Inspect its headings first, then
