...
- Upstream license: `BSD-2-Clause license`
- Inventory: `../../inventory.json`
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/gget/SKILL.md`
...
The upstream `SKILL.md` is 972 lines. Inspect its headings first, then
