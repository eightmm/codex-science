...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/venue-templates/SKILL.md`
...
The upstream `SKILL.md` is 687 lines. Inspect its headings first, then
