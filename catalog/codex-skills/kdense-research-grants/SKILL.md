...
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/research-grants/SKILL.md`
...
The upstream `SKILL.md` is 928 lines. Inspect its headings first, then
