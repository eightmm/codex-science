...
- Status: `inactive`
- Source: `kdense`
- Audit reasons: `credentials-required`, `executable-content`, `unknown-license`
- Upstream license: `Unknown`
- Inventory: `../../inventory.json`
- Upstream instructions: `../../../vendor/scientific-agent-skills/skills/latex-posters/SKILL.md`
...
The upstream `SKILL.md` is 1596 lines. Inspect its headings first, then
